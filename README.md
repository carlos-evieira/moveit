...
```bash
$ git clone https://github.com/https://github.com/carlos-evieira/moveit
```
...
[Move.it](https:/https://moveit-nextjs-chi.vercel.app/) came to remind you to exercise always! 💜 
